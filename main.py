...
class GIFMaker(tk.Tk):
    ...
    def __init__(self):
        ...
        self.canvas = tk.Canvas(self, width=500, height=300, background='#eeeeee')
    ...
    def animate_preview(self):
        ...
        frame_image = frame_image.resize((500, 300), Image.LANCZOS)
    ...
    def create_gif(self, fps, scale):
        ...
        output_frames[0].save(self.output_path, save_all=True, append_images=output_frames[1:],
